---
title: MinIO
"og:title": "How to host MinIO with Coolify"
...
Q: Invalid login?!
A: You need to run MinIO on `https` (not self-signed) to avoid this issue. MinIO doesn't support http based authentication.

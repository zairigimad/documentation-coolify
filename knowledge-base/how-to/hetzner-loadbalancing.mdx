...
"og:title": "How to deploy a loadbalanced application with Coolify on Hetzner"
...
<Tip>The whole infractructure costs around ~15€ per month.</Tip>
...
<Steps>
  ...
  <Step title="Add & validate them in Coolify">
  ...
  <Step title="Optional: Deploy your database">
  ...
  <Step title="Deploy your applications">
   ...
   <Step title="Add & configure the loadbalancer">

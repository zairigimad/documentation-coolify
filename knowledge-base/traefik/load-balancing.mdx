...
"og:title": "How to configure a load-balancer with Traefik in Coolify"
description: "A guide to configure load-balancing with Traefik in Coolify"
---
...
2. You must deploy your application to more than one servers: read more [here](../server/multiple-servers).

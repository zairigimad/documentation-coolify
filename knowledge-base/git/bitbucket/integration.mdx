---
title: "Integration"
"og:title": "How to configure Bitbucket based Git deployments with Coolify"
...
<Tip>
  - You can generate a new key pair with the following command: `ssh-keygen -t
  rsa -b 4096 -C " - Or you can also use Coolify to generate a new key for you
  in the `Keys & Tokens` menu.
</Tip>
...
<Tip>This can be set on either public or private repositories.</Tip>

---
title: "Build Server"
"og:title": "How to use a build server with Coolify"
...
- The server needs to be authenticated to the container registry. See [this](../docker/registry) for more information.

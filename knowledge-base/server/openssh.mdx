---
title: "OpenSSH"
"og:title": "How to configure OpenSSH for Coolify."
...
<Warning>Some commands may vary based on your Linux distribution.</Warning>
...
````
    ...
    <Step title="SSH Key set on the Server">
...
```
      ...
      <Step title="SSH Key set in Coolify">

...
description: "How to deploy to multiple servers."
---
...
- You must push the built image to a Docker Registry. Coolify automates the process, you just need to [login to the registry](/docker/registry#docker-credentials) on the server.
